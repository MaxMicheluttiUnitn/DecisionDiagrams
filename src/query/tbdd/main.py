...
from src.query.tbdd.commands import get_args
from src.query.util import is_tbdd_loading_folder_correct
...
def main():
    ...
    if not is_tbdd_loading_folder_correct(args.load_tbdd):
    ...
    query_manager = TBDDQueryManager(args.load_tbdd, refinement_mapping)
